...
public class Event {
    @Id
    @Column(name = "id")
    @GenericGenerator(name = "fc_event_id_seq", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
    parameters = {
    ...
    @JoinTable(name = "fc_player_event", joinColumns = {@JoinColumn(name = "id_event")},
